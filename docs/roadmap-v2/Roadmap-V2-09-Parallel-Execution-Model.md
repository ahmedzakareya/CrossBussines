...
| TAB-5 | Tasks and Calendar - UNASSIGNED | Task state and rules; calendar events and unified presentation. ALSO the restaurant inventory intelligence surface - actual vs theoretical consumption, waste attribution, replenishment and shortage - which the owner has been directing to this tab (dd112cc, d688886) and which no row claimed at all. The read screen is included; the equations stay in the service and are proven against a SQL probe database, not re-derived in the view. NOTE FOR THE OWNER: the Tab label still reads Tasks and Calendar, which no longer describes the whole of this tab. | UNASSIGNED - 2 live hosted services with no owner (R1 action) |
...
|---|---|---|
| TAB-1 | CrossBuy.Analyzers/**; CrossBuy.Analyzers.Tests/**; CrossBuy/BL/Platform/Bootstrap*; CrossBuy/BL/Platform/PlatformGrant*; CrossBuy/BL/Platform/Timeline*; CrossBuy/BL/*AccessService.cs; CrossBuy/Models/Platform/Bootstrap*; CrossBuy/Models/Platform/PlatformGrant*; CrossBuy/Models/Context/Platform/BootstrapAccessPolicy.cs; CrossBuy/Models/Context/Platform/PlatformRoleAssignment.cs; CrossBuy/Controllers/Api/PlatformGrantsApiController.cs; engineering/**; docs/platform/Stage-002A-*; docs/roadmap-v2/**; docs/stabilization/**; docs/integration/**; CrossBuy/CrossBuy.csproj; CrossBuy.sln; CrossBuy/Resources/**; CrossBuy/Views/Shared/**; CrossBuy/deploy/**; deploy/**; governance/**; .github/workflows/**; docs/platform/ADR-*; docs/deployment/**; CrossBuy/BL/Platform/**; CrossBuy/Models/Platform/**; CrossBuy/Models/Context/Platform/**; CrossBuy/BL/IntegrityCheckHostedService.cs; CrossBuy/BL/CrmReminderHostedService.cs; CrossBuy.Tests/Correction005StructuralTests.cs; CrossBuy.Tests/Stage1BypassTests.cs; CrossBuy.Tests/Stage1DiWiringTests.cs; CrossBuy.Tests/Stage1IsolationMatrixTests.cs; CrossBuy.Tests/Stage1QueryFilterTests.cs; CrossBuy.Tests/Stage1WriteGuardTests.cs; CrossBuy.Tests/Slice3WorkerCompanyTests.cs; CrossBuy.Tests/Slice3RuntimeGateTests.cs; CrossBuy.Tests/Slice3EventMonitorTests.cs; CrossBuy.Tests/Slice2TimelineTests.cs; CrossBuy.Tests/BusinessEventServiceTests.cs; CrossBuy.Tests/EventDispatchStoreTests.cs; CrossBuy.Tests/TimelineProjectionTests.cs; CrossBuy.Tests/NotificationProjectionTests.cs; CrossBuy.Tests/PrivateFileGateTests.cs; CrossBuy.Tests/PlatformShellGuardTests.cs; CrossBuy.Tests/NavigationGuardTests.cs; CrossBuy.Tests/BatchC1ScopeQueryTests.cs; CrossBuy.Tests/BatchCAdapterForwardingTests.cs; CrossBuy.Tests/D1Wave1CompanySourceTests.cs; CrossBuy.Tests/WorkerBusinessContextResolutionTests.cs; CrossBuy.Tests/AbandonedClaimRecoveryTests.cs; CrossBuy.Tests/HotfixA1AccountingApiTests.cs; CrossBuy.Tests/Slice3JournalReversalTests.cs; CrossBuy.Tests/Slice3ManufacturingSecurityTests.cs; CrossBuy.Tests/CrmVisibleOwnerScopeTests.cs; CrossBuy.Tests/UatDatasetSeederTests.cs; CrossBuy.Tests/SmokeTests.cs; CrossBuy.Tests/B6TestWiring.cs; CrossBuy.Tests/SqlServer/**; CrossBuy.Tests/InventoryApprovalReplayCompanyTests.cs; CrossBuy.Tests/PlatformPermissionCompanyCacheTests.cs; CrossBuy.Tests/Stage1ContextTests.cs; CrossBuy.Tests/PeriodPostingChokepointTests.cs; CrossBuy.Tests/DocumentLifecycleUiTests.cs; CrossBuy.Tests/DocumentAuthorityMemberTests.cs; CrossBuy.Tests/DocumentHttpLifecycleTests.cs; CrossBuy.Tests/WriterWorkerGovernanceTests.cs; CrossBuy.Tests/EntityConversationPartialContractTests.cs; CrossBuy.Tests/HrBootstrapPolicyTests.cs; CrossBuy.Tests/DocumentAccessFoundationTests.cs; CrossBuy.Tests/OnboardingLocalizationTests.cs; CrossBuy.Tests/DocumentSubmitContractTests.cs; CrossBuy.Tests/RosterLocalizationTests.cs; docs/handoff/** | Reporting, Communication, Construction trees |
| TAB-2 | CrossBuy.Tests/ReportingBusinessEventsDatasetTests.cs; CrossBuy.Tests/ReportingCatalogTests.cs; CrossBuy.Tests/ReportingDatasetTests.cs; CrossBuy.Tests/ReportingEngineTests.cs; CrossBuy.Tests/ReportingModuleDatasetTests.cs; CrossBuy.Tests/ReportingOutputTests.cs; CrossBuy.Tests/ReportingParameterEngineTests.cs; CrossBuy.Tests/ReportingPilotAndWorkspaceTests.cs; CrossBuy.Tests/ReportingScheduleTests.cs; CrossBuy.Tests/ReportingSecurityInvariantTests.cs; CrossBuy.Tests/ReportingShaperTests.cs; CrossBuy.Tests/ReportingTemplateScopeTests.cs; CrossBuy.Tests/ReportingUiSafetyTests.cs; CrossBuy.Tests/ReportingWriteAuthorizationTests.cs; CrossBuy/BL/Reporting/**; CrossBuy/Models/Context/Reporting/**; CrossBuy/Controllers/Api/ReportsCenterApiController.cs; CrossBuy/Views/Reports*/**; CrossBuy/deploy/sql/reporting_platform.sql; docs/platform/ADR-037*; CrossBuy/Controllers/Api/EmployeesApiController.cs; CrossBuy/Controllers/Api/HrApiController.cs; CrossBuy/Controllers/Api/LeaveApiController.cs; CrossBuy/Controllers/AdminController.Appraisals.cs; CrossBuy/Controllers/AdminController.Recruitment.cs; CrossBuy/Controllers/AdminController.Training.cs; CrossBuy/Controllers/PeopleController.cs; CrossBuy.Tests/LeaveApproverCompanyBoundaryTests.cs; CrossBuy.Tests/Hr/**; CrossBuy/deploy/sql/hr*.sql; deploy/sql/hr*.sql; CrossBuy/BL/Hr/EmployeeOnboardingService.cs; CrossBuy/Controllers/EmployeeOnboardingController.cs; CrossBuy/Models/Context/Hr/EmployeeOnboarding.cs; CrossBuy/Views/EmployeeOnboarding/**; CrossBuy/BL/Hr/RosterService.cs; CrossBuy/Controllers/RosterController.cs; CrossBuy/Models/Context/Hr/Roster.cs; CrossBuy/Views/Roster/** | Security, Communication, Construction trees |
| TAB-3 | CrossBuy/BL/Communication/**; CrossBuy/BL/Comm/**; CrossBuy/Models/Context/Communication/**; CrossBuy/Models/Context/Comm/**; CrossBuy/Models/Communication/**; CrossBuy/deploy/sql/communication_platform_slice_001.sql; CrossBuy/deploy/sql/comm_*; docs/platform/ADR-03[0-6]*; CrossBuy/BL/ChatService.cs; CrossBuy/Controllers/ChatController.cs; CrossBuy/Hubs/ChatHub.cs; CrossBuy/Views/Chat/**; CrossBuy/Resources/Views/Chat/**; CrossBuy/Models/Context/Chat/**; CrossBuy/deploy/sql/comm_chat_*.sql; CrossBuy/Hubs/ChatHub.cs; CrossBuy/Hubs/NotificationsHub.cs; CrossBuy.Tests/Communication/QuotationConversationTests.cs; CrossBuy/BL/Documents/**; CrossBuy/Views/Documents/**; CrossBuy/BL/Portal/**; CrossBuy/Controllers/ClientPortalController.cs; CrossBuy/Views/ClientPortal/**; CrossBuy/Models/Context/Portal/**; CrossBuy.Tests/Portal/**; CrossBuy/Models/Context/Documents/**; CrossBuy.Tests/Communication/PlatformDocumentTests.cs; CrossBuy/deploy/sql/documents_*.sql; CrossBuy/Controllers/DocumentsController.cs | Security, Reporting, Construction trees |
...
| TAB-5 | CrossBuy/BL/TaskService.cs; CrossBuy/BL/TasksAccessService.cs; CrossBuy/BL/TaskGeneratorHostedService.cs; CrossBuy/BL/TaskScheduleMatchHostedService.cs; CrossBuy/BL/CalendarService.cs; CrossBuy/Controllers/TasksController.cs; CrossBuy/Controllers/CalendarController.cs; CrossBuy.Tests/CalendarAccessServiceTests.cs; CrossBuy.Tests/CalendarConflictTests.cs; CrossBuy.Tests/CalendarDayGridViewModelTests.cs; CrossBuy.Tests/CalendarSchedulingTests.cs; CrossBuy.Tests/TaskCalendarTimelinePresentationTests.cs; CrossBuy.Tests/TaskEcosystemTests.cs; CrossBuy.Tests/TasksCalendarAgendaTests.cs; CrossBuy.Tests/TasksCalendarIntegrationTests.cs; CrossBuy.Tests/TasksCalendarTimeAndContractTests.cs; CrossBuy.Tests/TasksCalendarVisualConformanceTests.cs; CrossBuy.Tests/TasksWithoutCommunicationTests.cs; CrossBuy/BL/TasksCalendar/**; CrossBuy/Views/Tasks/**; CrossBuy/Views/Calendar/**; CrossBuy/deploy/sql/tasks_*; CrossBuy/deploy/sql/calendar.sql; CrossBuy/BL/RestaurantInventoryIntelligenceService.cs; CrossBuy/Controllers/RestaurantIntelligenceController.cs; CrossBuy/Views/RestaurantIntelligence/**; CrossBuy.Tests/SqlServer/PimInventoryIntelligenceTests.cs; CrossBuy.Tests/RestaurantIntelligenceScreenTests.cs | Other tabs' trees |
| TAB-6 | CrossBuy.Tests/WorkspaceAgendaPagingAndOverdueTests.cs; CrossBuy.Tests/WorkspaceReportSourceOwnershipTests.cs; CrossBuy/BL/Workspace/**; CrossBuy/Controllers/WorkspaceController.cs; CrossBuy/Views/Workspace/**; CrossBuy/BL/Approvals/**; CrossBuy/Controllers/ApprovalsController.cs; CrossBuy/Views/Approvals/**; CrossBuy/BL/ApprovalInboxDto.cs; CrossBuy/Controllers/ProjectController.cs; CrossBuy/BL/ProjectMembershipService.cs; CrossBuy/Models/Context/Accounting/ProjectMember.cs; CrossBuy/Views/Project/Team.cshtml; CrossBuy.Tests/Projects*Tests.cs; CrossBuy/BL/ProgressBillingService.cs; CrossBuy/Models/Context/Accounting/ProgressBilling.cs; CrossBuy/Views/Project/Billing.cshtml; CrossBuy.Tests/ApprovalInboxAggregatorTests.cs; CrossBuy.Tests/ApprovalCompanyIsolationTests.cs; CrossBuy/BL/AccountingPeriodControlService.cs; CrossBuy/BL/FiscalPeriodService.cs; CrossBuy/Models/Context/Accounting/AccountingFoundation.cs; CrossBuy.Tests/AccountingPeriodCloseTests.cs; CrossBuy/BL/ProjectCloseoutService.cs; CrossBuy/Models/Context/Accounting/ProjectCloseout.cs; CrossBuy/Controllers/ProjectCloseoutController.cs; CrossBuy/Views/ProjectCloseout/**; CrossBuy.Tests/ProjectCloseoutTests.cs | Other tabs' trees; approval WRITE paths in module services |
...
| SHF-19 | CrossBuy/Controllers/AccountingController.cs | Module surface - integration owner unblock only | Company-context remediation of named read paths, AND the SetPeriodStatus action only. SetPeriodStatus may route to IAccountingPeriodControlService and ask AccountingActions.PeriodClose / PeriodReopen at the boundary - it may hold no close condition, readiness rule or authority rule of its own; the policy lives in AccountingAccessService and the control service, which both re-ask before writing. No posting, stock, journal, receivable or payment behaviour may change under this entry. Changes require owner approval (-AllowShared). | Invoice read paths still resolve company from a compile-time constant while the product surface above them is company-scoped; the legacy business modules have no tab, so the screens cannot be fixed by their owner. |
...
| SHF-29 | CrossBuy/Controllers/DocumentsController.cs | Integration Owner - central document HTTP surface | The secure delivery and self-service lifecycle endpoints of the CENTRAL document platform. TAB-3 owns the document domain and lands lifecycle behaviour here; the Integration Owner lands the authorization-surface side - the endpoints whose credit depends on AuthorizationSurface.AuthorityTypes, and the refusal mapping that keeps an authorization-shaped refusal indistinguishable from absence (one 404) while an infrastructure failure answers 503. No module-specific behaviour may enter this file: it must never name an employee, an HR action or any other module's vocabulary. Changes require owner approval (-AllowShared). | The three self-service endpoints could not compile under CBA001 because they authorize one layer down, through IPlatformDocumentService - which is the whole design of ADR-040 and not a gap. Landing them therefore required a TAB-1 analyzer change and a TAB-1 landing on a TAB-3 file in the same commit. Neither tab can move this file alone without the other's half being wrong, which is what a shared file is. |
| SHF-30 | CrossBuy/BL/Documents/PlatformDocumentService.cs | Integration Owner - declared-authority surface only | TAB-3 owns the document domain and everything this service DOES. The Integration Owner owns one narrow thing about it: its PUBLIC MEMBER SET, because IPlatformDocumentService is declared in AuthorizationSurface.AuthorityTypes and CBA001 credits every endpoint that reaches it. Adding, removing or renaming a public member is therefore a governance act and needs the coverage in DocumentAuthorityMemberTests moved in the same change. Read models the members already return may be extended under this entry when doing so avoids widening the interface. No lifecycle rule, storage behaviour, authorization decision or validity semantics may change under it. Changes require owner approval (-AllowShared). | Batch 4 needed a lifecycle read for the documents screen. TAB-3 wrote the two members and correctly refused to land them, because widening a declared authority is not an edit its own tab can make alone. The resolution went the other way - ListForEntityAsync already authorizes per document, so its row carries the lifecycle and no member was added - but the coupling is permanent: this file is a product domain whose public shape is a security contract, and the two halves have different owners. |
| SHF-31 | CrossBuy.Tests/Approval*Tests.cs | Owner tab, plus compelled constructor updates | TAB-6 owns these suites and everything they ASSERT. A tab that changes the constructor of a service one of them builds may update THAT CALL and nothing else - no assertion, no fixture, no test added or removed, no behaviour change. The alternative is either a build broken for the owning tab or a defect left unfixed because its call sites are foreign, and neither is a real choice. Changes require owner approval (-AllowShared). | Platform stabilization resolved the company inside InventoryApprovalService, which is a TAB-1 scope defect - a hardcoded company on a production write path. The service gained a constructor parameter, and two TAB-6 suites construct it directly. One argument each; the fix and the call sites cannot land separately. |
| SHF-32 | CrossBuy/BL/InventoryApprovalService.cs | Module surface - company resolution only | The INVENTORY owner owns the approval workflow: thresholds, payload replay, notification, and every business rule about what may be approved. The Integration Owner owns one thing - how the company is obtained. That half must resolve through the platform's canonical IRequestCompanyResolver and must treat an unresolved company as an error rather than as company 1. No threshold, payload, replay, notification or approval rule may change under this entry. Changes require owner approval (-AllowShared). | The file carried a hardcoded company across twelve call sites, five of which write - the approval row, and on approval a purchase order, a transfer, a count and a write-off. It is registered in Program.cs and injected into InventoryController, so it was a production path, and half the class had already been migrated to BusinessContext, which is why it read as company-aware. The workflow belongs to Inventory; how it learns its tenant is a platform contract, and the file had no owner at all until this entry. |
