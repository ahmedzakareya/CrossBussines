...
namespace CrossBuy.Tests
{
    ...
    public class ProjectsBillingWorkflowTests
    {
        ...
        private sealed class JournalEntryServiceStub : IJournalEntryService
        {
            ...
            public Task<(bool ok, string? error)> UpdateDraftAsync(int entryId, int companyId, JournalEntryInput input, int? userId) => throw No();
            public Task<(bool ok, string? error)> DeleteDraftAsync(int entryId, int companyId, int? userId) => throw No();
        }
